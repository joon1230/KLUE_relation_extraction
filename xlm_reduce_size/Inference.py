...
def main(args):
    ...
    output.to_csv(f'/opt/ml/code/prediction/{model_name}.csv', index=False)
    pred_logit.to_csv(f'/opt/ml/code/prediction/logits/{model_name}_logit.csv', index=False)
...
if __name__ == '__main__':
    ...
    # model dir
    parser.add_argument('--model_dir', type=str, default="/opt/ml/code/my_BEST/XLMRoberta_Binary_ReduceSentenceQuery_Maxlength150/checkpoint-2200")
